...
<template>
    <section id="person-container">
        ...
        <div class="accountBalance">
            <span>账户总资金(BTC)</span>
            <h5>{{balance.length>3?balance.slice(0,-2):balance}}</h5>
            <!-- <button>去提现</button> -->
        </div>
        ...
        <transition enter-active-class="animated zoomIn" leave-active-class="animated zoomOut">
            ...
            <section v-if="subscribeImgIsShow" class="dialogs">
                <div class="referrer-container">
                    <img src="http://fast-mining.oss-cn-hangzhou.aliyuncs.com/upload/image/20190801/29682da1c8bc44b58f118cec138b95e8.png"
                         alt="">
...
<script>
    ...
    import {getUserInfo, isIos, isWX} from '@/global' // resolveTimeout, rejectTimeout
    export default {
        data() {
            return {
