...
<template>
    <section id="withdraw-page">
        ...
        <div class="list-container">
            ...
            <ul v-show="currentList.length" v-infinite-scroll="loadMore" infinite-scroll-disabled="isLoading"
                :infinite-scroll-immediate-check="true" infinite-scroll-distance="10">
                <component class="bottom-border" v-for="item in currentList" :item="item" :key="item.id"
...
<script>
    ...
    import {acalculationPower, energyGetPage, getExtractPage} from "@/api"
    ...
    export default {
        ...
        computed: {
            ...
            noDataImg() {
                let type = this.type
                return {
                    'extract': 'http://fast-mining.oss-cn-hangzhou.aliyuncs.com/upload/image/20190730/652dbf6a9013459cb76e404992fc26c3.png',
                    'energy': 'http://fast-mining.oss-cn-hangzhou.aliyuncs.com/upload/image/20190730/c48c1a2394e44f5398b40c5b4a1be488.png',
                    'acalculationPower': 'http://fast-mining.oss-cn-hangzhou.aliyuncs.com/upload/image/20190730/ca564db2fe614f2f8be54fa5a7150a70.png'
                }[type] || ''
            },
            currentComponent() {
                let type = this.type
