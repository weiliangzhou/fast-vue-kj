    ...
    >
      ...
      >
        <div>
          ...
          >
            <img
              :src="curentReferrerInfo.avatar || 'http:chuang-saas.oss-cn-hangzhou.aliyuncs.com/upload/image/20181208/2549e7234cb54d08bb667a43a5b8c8d0.png'"
              alt=""
            >
...
export default {
  data() {
    return {
      typesOption: [
        // 我的供货商两个tab选项
        { label: "供货商", id: 1, value: "saleUserInfo" },
